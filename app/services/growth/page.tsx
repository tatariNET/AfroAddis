    ...
    <div className="space-y-12 px-4 pb-24 pt-14 sm:px-8 lg:px-16 bg-[radial-gradient(circle_at_14%_18%,rgba(255,255,255,0.72),transparent_35%),radial-gradient(circle_at_86%_10%,rgba(226,232,240,0.55),transparent_30%)]">
      <header className="mx-auto max-w-3xl text-center space-y-3">
        ...
        <h1 className="text-4xl font-semibold text-gray-900 sm:text-5xl">
          Strategic growth topics retired
        </h1>
        <p className="text-lg text-gray-700">
          AfroAddis no longer promotes Mining, Vehicle Assembly, or Joint
          Venture topics as standalone service offerings. Please explore our
          Trading, Import, Export, Manufacturing, Real Estate, and Business 
          & Research divisions for current focus areas.
        </p>
      </header>
    </div>
  );
